...
def postprocess(det_output, w, h, batch_idx=0, interpolation_mode='bilinear',
    ...
    """
    boxes = torch.cat((boxes[classes==class_number1], boxes[classes==class_number2]),dim=0)
    scores = torch.cat((scores[classes==class_number1], scores[classes==class_number2]),dim=0)
    masks = torch.cat((masks[classes==class_number1], masks[classes==class_number2]),dim=0)
    classes = torch.cat((classes[classes==class_number1], classes[classes==class_number2]),dim=0)
    """
